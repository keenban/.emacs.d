...
#+END_SRC
*** irc
my personal irc setup
#+BEGIN_SRC emacs-lisp :tangle keenban/keenban-irc.el
  (require 'erc)
#+END_SRC
i like to hide the join, part, and quit messages. they tend to clutter up the chat in a busy channel
#+BEGIN_SRC emacs-lisp :tangle keenban/keenban-irc.el
  (setq erc-hide-list '("JOIN" "PART" "QUIT"))
#+END_SRC
i like to automatically sign in with nickserv and any other irc login bot
#+BEGIN_SRC emacs-lisp :tangle keenban/keenban-irc.el
